...
-- Write SQL query here
    ...
    SELECT countries.name, cities.name FROM countries INNER JOIN cities ON countries.name = cities.name WHERE countries.name = cities.name;
...
--               In a city of ninety-one thousand and now, eighty five.
    ...
    SELECT * FROM cities WHERE population >= 91084 AND population <= 91085 ORDER BY population ASC;
